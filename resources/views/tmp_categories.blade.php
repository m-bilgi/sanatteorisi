...
<html lang="tr">
    <head>
        ...
        <title>Sanat Teorisi - Articles</title>
    ...
    <body class="light" id="body">
        <div class="st-container" id="container">
            ...
            <main id="main">
                ...
                <section class="px-5 lg:px-10 py-5 bg-white text-gray-600 dark:bg-gray-700 dark:text-gray-300" id="article-categories">
                    <div class="py-5 border-b border-gray-300 dark:border-gray-600">
                        <h2>MAKALE ARŞİVİ</h2>
                        <p>Tüm kategoriler, tüm makaleler.</p>
                    </div>
                    <div class="grid md:grid-cols-2 xl:grid-cols-4">
                        <div class="p-5 lg:p-10">
                            <h3><a href="javascript:;" class="st-orange-link">Biyografiler</a></h3>
                            <ul class="p-3">
                                <li><a href="javascript:;" class="hover:underline">Fotoğraf Sanatçıları (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Heykeltraşlar (2)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Mimarlar (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Müzisyenler (4)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Ressamlar (31)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Şairler (15)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Sinema Oyuncuları (5)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Yazarlar (5)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Yönetmenler (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Felsefeciler (7)</a></li>
                            </ul>
                        </div>
                        <div class="p-5 lg:p-10">
                            <h3><a href="javascript:;" class="st-orange-link">Edebiyat</a></h3>
                            <ul class="p-3">
                                <li><a href="javascript:;" class="hover:underline">Hikaye ve Öyküler (15)</a></li>
                            </ul>
                        </div>
                        <div class="p-5 lg:p-10">
                            <h3><a href="javascript:;" class="st-orange-link">Makale ve Araştırmalar</a></h3>
                            <ul class="p-3">
                                <li><a href="javascript:;" class="hover:underline">Araştırmalar (33)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Denemeler (28)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Felsefe (29)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Köşe Yazıları (46)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Makaleler (149)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Müzik (6)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Resim ve Eser Analizleri (5)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Sanat Felsefesi ve Yazıları (4)</a></li>
                            </ul>
                        </div>
                        <div class="p-5 lg:p-10">
                            <h3><a href="javascript:;" class="st-orange-link">Sanat Akımları</a></h3>
                            <ul class="p-3">
                                <li><a href="javascript:;" class="hover:underline">Barok (0)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Dadaizim (3)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Fütürizm (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Klasisizm (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Kübizm (0)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Realizm (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Romantizm (0)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Rönesans (0)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Sembolizm (1)</a></li>
                                <li><a href="javascript:;" class="hover:underline">Sürrealizm (1)</a></li>
                            </ul>
                        </div>
                    </div>
                </section>
